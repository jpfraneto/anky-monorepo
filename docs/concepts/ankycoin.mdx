...
> Launch-scope note: this page describes an older web payment model. It is not the current mobile Sojourn 9 launch claim set. Current mobile credits use RevenueCat CREDITS, and `$ANKY` is a memetic/distribution layer that does not unlock the practice. Do not use this page to claim current mobile payments, token rewards, or launch readiness.
