# GODS by Anky - Complete Architecture

> **A storytelling series introducing humanity's collective unconscious through the lens of Anky.**

---

## Vision

**One-line:** GODS is a reimagination of the different cultures that have given birth to humanity. To our collective unconscious. We used to talk in terms of stories. Let's get back those stories.

**Core mechanism:** Each god is told through the lens of Anky. Anky narrates. The tale is told by Anky.
...
- VAE: `ae.safetensors`
- CLIP: `clip_l.safensors` + `t5xxl_fp8_e4m3fn.safetensors`
- Sampler: Euler, 20 steps, cfg 3.5
- Seeds: Unique per scene (base 42 + scene_index * 1000)

**Location:** `~/anky/scripts/image_generation_pipeline.py`
...
- `~/anky/videos/gods/{god_name}/` - Per-god assets
...
**🔜 Next:**
- Generate 8 more gods (9-day sojourn)
...
```bash
# Generate images for a god
cd ~/anky
python3 scripts/image_generation_pipeline.py "god_name"

# Generate short video
python3 scripts/gods_video_pipeline.py "god_name" short

# Generate long-form video
python3 scripts/gods_video_pipeline.py "god_name" long

# Upload to YouTube
youtube-uploader upload ~/anky/videos/gods/god_name/god_name_short.webm
```
...
**The unconscious is talking.** Through the writing. Through the stories. Through the gods.
